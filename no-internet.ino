...
bool drawHero(
  ...
  char upperSave = terrainUpper[heroX];
  char lowerSave = terrainLower[heroX];
  ...
  terrainUpper[heroX] = upperSave;
  terrainLower[heroX] = lowerSave;
...
void loop() {
  ...
  if (
    ...
    digitalWrite(
      PIN_AUTOPLAY,
      terrainLower[heroX + 2] == SPRITE_TERRAIN_EMPTY
      ? HIGH
      : LOW
    );
  }
